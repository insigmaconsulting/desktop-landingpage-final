...
export const Footer = () => {
  return (
    <footer className="bg-[rgba(245,243,237,1)] self-center flex w-[1392px] max-w-full flex-col items-center mt-[142px] pt-[84px] px-20 rounded-3xl max-md:mt-10 max-md:px-5">
      <div className="w-full max-w-[1169px] max-md:max-w-full">
        <div className="flex w-full max-w-[1144px] gap-5 flex-wrap justify-between mr-6 max-md:max-w-full max-md:mr-2.5">
          ...
          <div className="flex items-stretch gap-[40px_50px]">
            <div className="flex flex-col items-stretch text-[rgba(147,146,142,1)] font-normal tracking-[-0.32px]">
        ...
        <div className="flex items-stretch gap-5 text-sm text-[rgba(147,146,142,1)] font-normal tracking-[-0.28px] flex-wrap justify-between mt-[103px] max-md:max-w-full max-md:mr-[5px] max-md:mt-10">
          <a href="/privacy" className="leading-[1.4]">
            Privacy
          </a>
          <p className="leading-[1.3]">© 2025 Okopod. All rights reserved.</p>
        </div>
        <img
