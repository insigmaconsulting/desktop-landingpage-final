...
export const ContactVisit = () => {
    //   // For Vite projects, your API key should be in .env as VITE_GOOGLE_MAPS_API_KEY
    //   const mapKey = import.meta.env.VITE_GOOGLE_MAPS_API_KEY;
    //   const address = "1st Floor, 381, Ismail Bldg, Dadabhai Naoroji Road, Flora Fountain, Pune - 444805";
    //   const mapSrc = `https://www.google.com/maps/embed/v1/place?key=${mapKey}&q=${encodeURIComponent(
    //     address
    //   )}`;
                            ...
                            <div className="bg-red-100 w-[50%] max-md:w-full max-md:ml-0">
                                <div className="mx-5 h-full">
                                    <iframe
                                        ...
                                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3782.1234567890123!2d73.85678901234567!3d18.519345678901234!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bc2c0a4b5c6d7e8%3A0x9abcdef123456789!2sIsmail%20Building%2C%20Flora%20Fountain%2C%20Pune%2C%20Maharashtra%20441105!5e0!3m2!1sen!2sin!4v1612345678901!5m2!1sen!2sin"
                                        width="100%"
                                        height="100%"
                                        style={{ border: 0 }}
                                        allowFullScreen
