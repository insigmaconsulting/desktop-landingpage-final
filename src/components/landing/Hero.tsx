...
export const Hero = () => {
  return (
    ...
    <section className="w-full aspect-[16/6.5] max-w-[1470px] mx-auto relative overflow-hidden text-[70px] text-white font-normal leading-[1.1] px-10 pt-[250px] pb-20 rounded-[30px] max-md:text-[40px] max-md:px-5">
      <img
